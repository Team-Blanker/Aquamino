...
AqRS.kickTable={
    L={
        R={
            ...
            {{0,0},{ 1, 0},{ 1,-1},{ 0, 1},{ 0, 2},{ 1, 1},{ 1, 2},{-1, 1},{-1, 0}},--R->2
            {{0,0},{ 1, 0},{ 1, 1},{ 0,-2},{ 1,-1},{ 1,-2},{ 0,-1},{-1,-1},{ 0, 1}},--2->L
            {{0,0},{-1, 0},{-1,-1},{ 0,-1},{ 0, 2},{-1, 1},{-1, 2},{ 1,-1},{ 1, 0}} --L->0
        },
        L={
            {{0,0},{ 1, 0},{ 1, 1},{ 0, 1},{ 0,-2},{ 1,-1},{ 1,-2},{-1, 1},{-1, 0}},--0->L
            {{0,0},{ 1, 0},{ 1,-1},{ 0, 2},{ 1, 1},{ 1, 2},{ 0,-1},{-1,-1},{ 0, 1}},--R->0
            {{0,0},{-1, 0},{-1, 1},{ 0,-1},{ 0,-2},{-1,-1},{-1,-2},{ 1,-1},{ 1, 0}},--2->R
