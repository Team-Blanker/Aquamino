...
function pause.init(mino)
    ...
    pause.button.create('pause_resume',{
        ...
        draw=function(bt,t)
            ...
            gc.setColor(1,1,1)
            gc.printf(ptxt.resume,font.Bender,0,0,1280,'center',0,.5,.5,640,76)
        end,
        event=function()
    ...
    pause.button.create('pause_retry',{
        ...
        draw=function(bt,t)
            ...
            gc.rectangle('line',-200,-50,400,100)
            gc.setColor(1,1,1)
            gc.printf(ptxt.r,font.Bender,0,0,1280,'center',0,.5,.5,640,76)
        end,
        event=function()
    ...
    pause.button.create('pause_quit',{
        ...
        draw=function(bt,t)
            ...
            gc.rectangle('line',-200,-50,400,100)
            gc.setColor(1,1,1)
            gc.printf(ptxt.quit,font.Bender,0,0,1280,'center',0,.5,.5,640,76)
        end,
        event=function()
