...
function rule.init(P,mino)
    ...
    mino.musInfo="守已 - アトモスフィア (Atmosphere)"
...
function rule.underFieldDraw(player)
    ...
    gc.setColor(1,1,1)
    gc.printf(""..player.remainLine,font.JB,x,-42,6000,'center',0,.625,.625,3000,font.height.JB/2)
    gc.printf(rd.remain,font.JB_B,x,6,6000,'center',0,.2,.2,3000,font.height.JB_B/2)
    gc.printf(""..player.pieceCount,font.JB,x,54,6000,'center',0,.4,.4,3000,font.height.JB/2)
    gc.printf(rd.piece,font.JB_B,x,90,6000,'center',0,.2,.2,3000,font.height.JB_B/2)
end
