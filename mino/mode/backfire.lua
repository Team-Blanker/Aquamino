...
function rule.underFieldDraw(player)
    ...
    gc.setColor(1,1,1)
    gc.printf(""..max(80-player.recvLine,0),font.JB,x,-42,6000,'center',0,.6,.6,3000,font.height.JB/2)
    gc.printf(rb.remain,font.JB_B,x,6,6000,'center',0,.2,.2,3000,font.height.JB/2)
    efftxt=player.line==0 and "-" or string.format("%.2f",player.atk/player.line)
    gc.printf(efftxt,font.JB,x,54,6000,'center',0,.4,.4,3000,font.height.JB/2)
    gc.printf(rb.eff,font.JB_B,x,90,6000,'center',0,.2,.2,3000,font.height.JB/2)
end
