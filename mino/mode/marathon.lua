...
function rule.underFieldDraw(player)
    ...
    gc.printf(""..player.speedLv*10,font.JB_B,-player.w*18-110,42,2048,'center',0,.5,.5,1024,font.height.JB_B/2)
    gc.printf("Level "..player.speedLv,font.JB_B,-player.w*18-28,288,2048,'right',0,.25,.25,2048,font.height.JB_B/2)
    gc.setLineWidth(6)
