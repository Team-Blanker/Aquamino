...
function rule.underFieldDraw(player,mino)
    ...
    for i=1,#barOrder do
        ...
        local displayText = (bb.lvl == 6) and "MAX" or string.format("%d", 2 ^ bb.lvl)
        gc.printf(displayText,font.Bender_B,18*player.w+35,18*player.h-40*i+5,2000,'left',0,.2,.2,0,72)
    end
    setColor(1,1,1)
