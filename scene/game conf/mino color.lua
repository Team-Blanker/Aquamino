...
function bc.init()
    ...
    SLIDER.create('colorR',{
        ...
        sliderDraw=function(g,sz)
            ...
            gc.setColor(1,.5,.5)
            gc.printf(string.format("R:%.2f(%.2X)",v,v*255+.5),font.JB,-210,-48,1000,'left',0,.3125,.3125,0,84)
        end,
    ...
    SLIDER.create('colorG',{
        ...
        sliderDraw=function(g,sz)
            ...
            gc.polygon('fill',-sz[1]/2-8,0,-sz[1]/2,-8,sz[1]/2,-8,sz[1]/2+8,0,sz[1]/2,8,-sz[1]/2,8)
            gc.setColor(.5,1,.5)
            gc.printf(string.format("G:%.2f(%.2X)",v,v*255+.5),font.JB,-210,-48,1000,'left',0,.3125,.3125,0,84)
        end,
        buttonDraw=function(pos,sz)
            gc.setColor(1,1,1)
            gc.circle('fill',sz[1]*(pos-.5),0,20,4)
    ...
    SLIDER.create('colorB',{
        ...
        sliderDraw=function(g,sz)
            ...
            gc.polygon('fill',-sz[1]/2-8,0,-sz[1]/2,-8,sz[1]/2,-8,sz[1]/2+8,0,sz[1]/2,8,-sz[1]/2,8)
            gc.setColor(.5,.5,1)
            gc.printf(string.format("B:%.2f(%.2X)",v,v*255+.5),font.JB,-210,-48,1000,'left',0,.3125,.3125,0,84)
        end,
        buttonDraw=function(pos,sz)
            gc.setColor(1,1,1)
            gc.circle('fill',sz[1]*(pos-.5),0,20,4)
