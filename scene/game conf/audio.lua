...
function audio.init()
    ...
    BUTTON.create('distractCut',{
        ...
        draw=function(bt,t,ct)
            ...
            gc.setColor(1,1,1)
            gc.printf(cf.audio.distract,font.Bender_B,w/2+25+cf.audio.DOX,0,1200,'left',0,.25,.25,0,76)
...
function audio.draw()
    gc.setColor(1,1,1)
    gc.printf(cf.main.audio,font.Bender,0,-430,1280,'center',0,1,1,640,76)
