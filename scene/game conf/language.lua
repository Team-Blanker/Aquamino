...
function lang.init()
    ...
    BUTTON.create('zh-CN',{
        ...
        draw=function(bt,t,ct)
            ...
            gc.rectangle('line',-w/2,-h/2,w,h,6)
            gc.setColor(1,1,1)
            gc.printf("简体中文",Exo_2,0,0,1280,'center',0,.8,.8,640,84)
    ...
    BUTTON.create('English',{
        ...
        draw=function(bt,t,ct)
            ...
            gc.rectangle('line',-w/2,-h/2,w,h,6)
            gc.setColor(1,1,1)
            gc.printf("English",Exo_2,0,0,1280,'center',0,.8,.8,640,84)
...
function lang.draw()
    gc.setColor(1,1,1)
    gc.printf("语言/Language",Exo_2,0,-460,1280,'center',0,1,1,640,84)
    gc.printf(user.lang.conf.lang.cur,Exo_2,0,-300,5000,'center',0,.5,.5,2500,84)
