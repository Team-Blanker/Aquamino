...
function warn.draw()
    ...
    gc.printf(w.title,font.Exo_2,0,-300,3000,'center',0,.6,.6,1500,84)
    gc.setColor(.5,1,.75,2*scene.time-.5)
    gc.printf(w.txt,font.Exo_2,0,-160,w.txtWidth,'center',0,w.txtScale,w.txtScale,w.txtWidth*.5,84)
end
