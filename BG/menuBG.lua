local bg={}
local phi=(5^.5-1)/2 --黄金比=0.6180339887...
local dot={
...
--[[local edge={--小星形十二面体
    ...
    1,11, 1,12, 4,11, 4,12, 2,9, 2,10, 3,9, 3,10,
    5,3, 5,4, 8,3, 8,4, 6,1, 6,2, 7,1, 7,2,
    9,7, 9,8, 12,7, 12,8, 10,5, 10,6, 11,5, 11,6,
}]]
...
function bg.draw()
    op[4]=scene.totalTime*.55 op[8]=-scene.totalTime*.25
    gc.push()
        gc.origin()
